...
```{r A2_edgeR1, warning=FALSE, message=FALSE, echo=FALSE, fig.align='center'}
# by cell type model
expressionMatrix <- as.matrix(gata3_data)
...
plot(df_edger[,1:2], 
     col=df_edger$color, 
     main = "Figure 6: GATA3 RNASeq Samples Volcano Plots Comparison by using QLF Method")
legend("topright", 
...
```{r dark_matter_png, echo=FALSE, fig.cap="Figure Dark Matter", fig.align='center', fig.dim=c(200,200), fig.cap="Figure 9: Dark Matter Overlap Venn Diagram. The "}
...
```{r heatmap_2, warning=FALSE, message=FALSE, echo=FALSE,  fig.cap="Figure 11: Heatmap for genes with annotation but not in enrichment results", fig.align='center'}
