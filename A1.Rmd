...
+ What is the final coverage of your dataset?
    ...
    - The final coverage is in `gata3_cleaned_maped_data` as shown at the end of the cleaning section. 12464 genes with 8 columns (original identifier, new added HGNC symbols (rowname), across 3 samples expression values).
<br>
