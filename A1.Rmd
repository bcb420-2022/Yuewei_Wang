...
### Final coverage:
```{r}
gata3_cleaned_maped_annot <- gata3_cleaned_maped_data[,3:8]
rownames(gata3_cleaned_maped_annot) = gata3_cleaned_maped_data$hgnc_symbols
colnames(gata3_cleaned_maped_annot) = samples[,1]
dim(gata3_cleaned_maped_annot)
head(gata3_cleaned_maped_annot)
```
